                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            <div>
                                <h1>Edit Gula Darah</h1>
                                <a href="<?= base_url('apps/dem') ?>">Dashboard</a> / <a href="<?= base_url('apps/dem/guladarah_list') ?>">Gula Darah</a> / Edit Gula Darah</p>
                            </div>
                            <div>
    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
        <div class="row" data-aos="fade-up" data-aos-delay="700">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form class="row g-3 needs-validation" action="<?= base_url('apps/dem/guladarah_update_control') ?>" method="POST" novalidate>
                            <?= csrf_field(); ?>
                            <div class="col-md-12">
                                <input type="text" name="guladarah" class="form-control form-control-sm " value="<?= $gula['guladarah'] ?>" placeholder="Gula Darah" required>
                                <div class="invalid-feedback">
                                    Harap Isi Gula Darah Anda
                                </div>
                            </div>
                            <div class="col-md-12">
                                <input type="date" name="tanggal" class="form-control form-control-sm" value="<?= $gula['tanggal'] ?>" required>
                                <div class="invalid-feedback">
                                    Harap Isi Tanggal
                                </div>
                            </div>
                            ...
                            <div class="d-inline">
                                <input type="hidden" name="id" value="<?= $gula['id'] ?>">
