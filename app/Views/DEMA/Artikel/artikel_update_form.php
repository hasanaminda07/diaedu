                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="flex-wrap d-flex justify-content-between align-items-center">
                            <div>
                                <h1>Edit Edukasi</h1>
                                <a href="<?= base_url('apps/dema') ?>">Dashboard</a> / <a href="<?= base_url('apps/dema/artikel_list') ?>">Edukasi</a> / Edit Edukasi</p>
                            </div>
                            <div>
    ...
    <div class="conatiner-fluid content-inner mt-n5 py-0">
        <div class="row" data-aos="fade-up" data-aos-delay="700">
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-body">
                        <form class="row g-3 needs-validation" action="<?= base_url('apps/dema/artikel_update_control') ?>" method="POST" novalidate>
                            <?= csrf_field(); ?>
                            <div class="col-md-12">
                                <input type="text" name="judul" class="form-control form-control-sm " id="validationCustom03" placeholder="Judul Artikel" value="<?= $artikel['judul'] ?> " required>
                            ...
                            <div class="col-md-12">
                                <textarea name="banner" id="editorBanner" placeholder="Banner"><?= $artikel['banner'] ?></textarea>
                            </div>
                            <div class="col-md-12">
                                <textarea name="konten" id="editorArtikel" placeholder="Edukasi"><?= $artikel['konten'] ?></textarea>
                            </div>
                            <div class="d-inline">
