                        ...
                        <div class="col-md-10">
                            <div class="card card-transparent auth-card shadow-none d-flex justify-content-center mb-0">
                                <div class="card-body">
                                    ...
                                    <h2 class="mb-2 text-center">Lupa Password</h2><br>
                                    <br>
                                    <form class="row g-3 needs-validation" action="<?= base_url('reset') ?>" method="POST" novalidate>
                                        <?= csrf_field(); ?>
                                        ...
                                        <p class="mt-3 text-center">
                                            Sudah punya akun ? <a href="<?= base_url('') ?>" class="text-underline">Masuk</a><br>
                                            Belum punya akun ? <a href="<?= base_url('daftar') ?>" class="text-underline">Daftar</a>
                                        </p>
                                    </form>
                                </div>
                            </div>
